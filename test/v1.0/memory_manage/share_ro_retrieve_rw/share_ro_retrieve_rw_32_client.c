...
static uint32_t share_ro_retrieve_rw_32_client(uint32_t test_run_data)
{
    ffa_args_t payload;
...
uint32_t share_ro_retrieve_rw_32_vmsp_client(uint32_t test_run_data)
{
    return share_ro_retrieve_rw_32_client(test_run_data);
}

uint32_t share_ro_retrieve_rw_32_spsp_client(uint32_t test_run_data)
{
    return share_ro_retrieve_rw_32_client(test_run_data);
}

uint32_t share_ro_retrieve_rw_32_vmvm_client(uint32_t test_run_data)
{
    return share_ro_retrieve_rw_32_client(test_run_data);
}
