...
static uint32_t share_ro_retrieve_rw_32_server(ffa_args_t args)
{
    ffa_args_t payload;
    ...
    {
        LOG(ERROR, "Unexpected return code for Mem retrieve req %x", payload.fid);
...
uint32_t share_ro_retrieve_rw_32_vmsp_server(ffa_args_t args)
{
    return share_ro_retrieve_rw_32_server(args);
}

uint32_t share_ro_retrieve_rw_32_spsp_server(ffa_args_t args)
{
    return share_ro_retrieve_rw_32_server(args);
}

uint32_t share_ro_retrieve_rw_32_vmvm_server(ffa_args_t args)
{
    return share_ro_retrieve_rw_32_server(args);
}
