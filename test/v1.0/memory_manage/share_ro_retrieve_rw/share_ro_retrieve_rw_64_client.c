...
static uint32_t share_ro_retrieve_rw_64_client(uint32_t test_run_data)
{
    ffa_args_t payload;
...
uint32_t share_ro_retrieve_rw_64_vmsp_client(uint32_t test_run_data)
{
    return share_ro_retrieve_rw_64_client(test_run_data);
}

uint32_t share_ro_retrieve_rw_64_spsp_client(uint32_t test_run_data)
{
    return share_ro_retrieve_rw_64_client(test_run_data);
}

uint32_t share_ro_retrieve_rw_64_vmvm_client(uint32_t test_run_data)
{
    return share_ro_retrieve_rw_64_client(test_run_data);
}
