...
#define MEM_DONATE_TAG 0xAABBCCDD
...
static uint32_t ffa_mem_donate_helper(uint32_t test_run_data, uint32_t fid)
{
    ...
    mem_region_init.tag = MEM_DONATE_TAG;
...
uint32_t donate_invalid_handle_tag_client(uint32_t test_run_data)
{
