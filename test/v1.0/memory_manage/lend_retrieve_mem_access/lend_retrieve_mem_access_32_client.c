...
uint32_t lend_retrieve_mem_access_32_vmsp_client(uint32_t test_run_data)
{
...
uint32_t lend_retrieve_mem_access_32_vmvm_client(uint32_t test_run_data)
{
    return lend_retrieve_mem_access(test_run_data);
}

uint32_t lend_retrieve_mem_access_32_spsp_client(uint32_t test_run_data)
{
    return lend_retrieve_mem_access(test_run_data);
}
