...
static uint32_t lend_retrieve_mem_access_32_server(ffa_args_t args)
{
    ffa_args_t payload;
...
uint32_t lend_retrieve_mem_access_32_vmvm_server(ffa_args_t args)
{
    return lend_retrieve_mem_access_32_server(args);
}

uint32_t lend_retrieve_mem_access_32_vmsp_server(ffa_args_t args)
{
    return lend_retrieve_mem_access_32_server(args);
}

uint32_t lend_retrieve_mem_access_32_spsp_server(ffa_args_t args)
{
    return lend_retrieve_mem_access_32_server(args);
}
