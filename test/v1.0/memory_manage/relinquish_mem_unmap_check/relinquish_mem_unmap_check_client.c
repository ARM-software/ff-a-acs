...
static uint32_t relinquish_mem_unmap_check_client(uint32_t test_run_data)
{
    uint32_t status_32, status_64, status = VAL_SKIP_CHECK;
...
uint32_t relinquish_mem_unmap_check_vmsp_client(uint32_t test_run_data)
{
    return relinquish_mem_unmap_check_client(test_run_data);
}

uint32_t relinquish_mem_unmap_check_vmvm_client(uint32_t test_run_data)
{
    return relinquish_mem_unmap_check_client(test_run_data);
}

uint32_t relinquish_mem_unmap_check_spsp_client(uint32_t test_run_data)
{
    return relinquish_mem_unmap_check_client(test_run_data);
}
