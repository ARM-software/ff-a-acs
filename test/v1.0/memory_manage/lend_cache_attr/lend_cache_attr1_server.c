...
uint32_t lend_cache_attr1_server(ffa_args_t args)
{
    ffa_args_t payload;
    ...
    {
        LOG(ERROR, "The Relayer must return denied for cacheability attribute mismatch err %x\n",
                                                         payload.arg2);
    ...
    LOG(DBG, "Mem Cache Attribute Precedence Check Complete\n");
