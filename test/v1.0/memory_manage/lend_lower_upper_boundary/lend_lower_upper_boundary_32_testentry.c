...
void lend_lower_upper_boundary_32_vmsp_testentry(uint32_t test_num)
{
...
void lend_lower_upper_boundary_32_spsp_testentry(uint32_t test_num)
{
...
void lend_lower_upper_boundary_32_vmvm_testentry(uint32_t test_num)
{
