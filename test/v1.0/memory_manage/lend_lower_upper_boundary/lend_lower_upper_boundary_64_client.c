...
static uint32_t lend_lower_upper_boundary_64_client(uint32_t test_run_data)
{
    ffa_args_t payload;
...
uint32_t lend_lower_upper_boundary_64_vmsp_client(uint32_t test_run_data)
{
    return lend_lower_upper_boundary_64_client(test_run_data);
}

uint32_t lend_lower_upper_boundary_64_spsp_client(uint32_t test_run_data)
{
    return lend_lower_upper_boundary_64_client(test_run_data);
}

uint32_t lend_lower_upper_boundary_64_vmvm_client(uint32_t test_run_data)
{
    return lend_lower_upper_boundary_64_client(test_run_data);
}
