...
static uint32_t lend_lower_upper_boundary_32_server(ffa_args_t args)
{
    ffa_args_t payload;
...
uint32_t lend_lower_upper_boundary_32_vmsp_server(ffa_args_t args)
{
    return lend_lower_upper_boundary_32_server(args);
}

uint32_t lend_lower_upper_boundary_32_spsp_server(ffa_args_t args)
{
    return lend_lower_upper_boundary_32_server(args);
}

uint32_t lend_lower_upper_boundary_32_vmvm_server(ffa_args_t args)
{
    return lend_lower_upper_boundary_32_server(args);
}
