...
uint32_t donate_mem_access_after_donate_32_vm_client(uint32_t test_run_data)
{
...
uint32_t donate_mem_access_after_donate_32_sp_client(uint32_t test_run_data)
{
    return donate_mem_access_after_donate(test_run_data);
}
