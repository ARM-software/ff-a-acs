...
uint32_t lend_retrieve_input_checks6_server(ffa_args_t args)
{
    ffa_args_t payload;
    ...
    LOG(DBG, "Mem Retrieve Request for Invalid Sender ID Complete\n");
    ...
    LOG(DBG, "Mem Retrieve Request for Invalid total Length Complete\n");
