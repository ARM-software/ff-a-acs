...
static uint32_t mem_share_shareability_attr_check(uint32_t test_run_data, uint32_t fid,
                void *tx_buf, enum ffa_memory_shareability shareability)
{
...
static uint32_t ffa_mem_share_handle_helper(uint32_t test_run_data, uint32_t fid)
{
    ...
    status = mem_share_shareability_attr_check(test_run_data, fid, mb.send,
...
uint32_t share_shareability_attr1_client(uint32_t test_run_data)
{
