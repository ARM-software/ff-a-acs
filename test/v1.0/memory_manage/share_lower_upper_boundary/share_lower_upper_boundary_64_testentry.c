...
void share_lower_upper_boundary_64_vmsp_testentry(uint32_t test_num)
{
...
void share_lower_upper_boundary_64_spsp_testentry(uint32_t test_num)
{
...
void share_lower_upper_boundary_64_vmvm_testentry(uint32_t test_num)
{
