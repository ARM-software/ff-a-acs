...
static uint32_t share_lower_upper_boundary_64_server(ffa_args_t args)
{
    ffa_args_t payload;
...
uint32_t share_lower_upper_boundary_64_vmsp_server(ffa_args_t args)
{
    return share_lower_upper_boundary_64_server(args);
}

uint32_t share_lower_upper_boundary_64_spsp_server(ffa_args_t args)
{
    return share_lower_upper_boundary_64_server(args);
}

uint32_t share_lower_upper_boundary_64_vmvm_server(ffa_args_t args)
{
    return share_lower_upper_boundary_64_server(args);
}
