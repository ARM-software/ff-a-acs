...
static uint32_t share_lower_upper_boundary_32_client(uint32_t test_run_data)
{
    ffa_args_t payload;
...
uint32_t share_lower_upper_boundary_32_vmsp_client(uint32_t test_run_data)
{
    return share_lower_upper_boundary_32_client(test_run_data);
}

uint32_t share_lower_upper_boundary_32_spsp_client(uint32_t test_run_data)
{
    return share_lower_upper_boundary_32_client(test_run_data);
}

uint32_t share_lower_upper_boundary_32_vmvm_client(uint32_t test_run_data)
{
    return share_lower_upper_boundary_32_client(test_run_data);
}
