...
static uint32_t share_lower_upper_boundary_32_server(ffa_args_t args)
{
    ffa_args_t payload;
    ...
    if (g_handler_lower && g_handler_upper)
        ...
        violation_status = VAL_ERROR_POINT(8);
...
uint32_t share_lower_upper_boundary_32_vmsp_server(ffa_args_t args)
{
    return share_lower_upper_boundary_32_server(args);
}

uint32_t share_lower_upper_boundary_32_spsp_server(ffa_args_t args)
{
    return share_lower_upper_boundary_32_server(args);
}

uint32_t share_lower_upper_boundary_32_vmvm_server(ffa_args_t args)
{
    return share_lower_upper_boundary_32_server(args);
}
