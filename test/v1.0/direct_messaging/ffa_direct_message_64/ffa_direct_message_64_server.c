...
uint32_t ffa_direct_message_64_server(ffa_args_t args)
{
    ...
    if (payload.arg3 != expected_req_data_64.arg3 ||
        payload.arg4 != expected_req_data_64.arg4 ||
    ...
    if (val_is_ffa_feature_supported(FFA_MSG_POLL_32)) {
        val_memset(&payload, 0, sizeof(ffa_args_t));
