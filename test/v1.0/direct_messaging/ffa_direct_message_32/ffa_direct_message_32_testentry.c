...
void ffa_direct_message_32_testentry(uint32_t test_num)
{
    ...
    /* Execute test for EP combination: client=SP1, server=VM2 */
    if (IS_TEST_FAIL(val_execute_test(test_num, SP1, VM2)))
        return;
}
