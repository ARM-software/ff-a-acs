...
uint32_t other_secure_int1_client(uint32_t test_run_data)
{
    ffa_args_t payload;
    ...
    ffa_endpoint_id_t recipient_1 = val_get_endpoint_id(SP4);
    mb_buf_t mb;
    ...
    LOG(DBG, "T-WD IRQ Disabled, Schedule SP using FFA_RUN\n");
