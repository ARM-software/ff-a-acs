...
const test_db_t test_list[] = {
    ...
    CLIENT_SERVER_TEST_FN(TESTSUITE_MEMORY_MANAGE, mem_share_mmio, FFA_MEM_SHARE_ANY),
...
#ifdef ACS_FFA_UNVERIFIED
    CLIENT_SERVER_TEST_FN(
        TESTSUITE_DIRECT_MESSAGING, ffa_direct_message_error2, FFA_MSG_SEND_DIRECT_REQ_64),
#endif
#endif
...
#ifdef ACS_FFA_UNVERIFIED
    CLIENT_SERVER_SEC_CPU_CLIENT_TEST_FN(
        TESTSUITE_INTERRUPTS, vm_to_up_sp_preempt, FFA_FID_SKIP_CHECK),
    CLIENT_SERVER_TEST_FN(TESTSUITE_INTERRUPTS, vm_to_sp_managed_exit_4, FFA_FID_SKIP_CHECK),
    CLIENT_SERVER_TEST_FN(TESTSUITE_INTERRUPTS, other_secure_int2, FFA_FID_SKIP_CHECK),
    CLIENT_SERVER_TEST_FN(TESTSUITE_INTERRUPTS, other_secure_int7, FFA_FID_SKIP_CHECK),
...
#ifdef ACS_FFA_UNVERIFIED
    CLIENT_TEST_FN_ONLY(TESTSUITE_SETUP_DISCOVERY, ffa_console_log, FFA_CONSOLE_LOG_ANY),
#endif
#endif

#if (SUITE == all || SUITE == direct_messaging)
#ifdef ACS_FFA_UNVERIFIED
    CLIENT_SERVER_TEST_FN(TESTSUITE_DIRECT_MESSAGING, ffa_run_direct_req, FFA_RUN_32),
#endif
#endif
...
#ifdef ACS_FFA_UNVERIFIED
    CLIENT_SERVER_TEST_FN(
        TESTSUITE_MEMORY_MANAGE, lend_multi_borrower_flag_check, FFA_MEM_LEND_ANY),
#endif
#endif
...
#ifdef ACS_FFA_UNVERIFIED
    CLIENT_SERVER_TEST_FN(
        TESTSUITE_INDIRECT_MESSAGING, ffa_msg_send2_uuid_check, FFA_MSG_SEND2_32),
#endif
#endif
...
#ifdef ACS_FFA_UNVERIFIED
    CLIENT_SERVER_TEST_FN(TESTSUITE_INTERRUPTS, sp_yield_spmc_mode, FFA_FID_SKIP_CHECK),
#endif
#endif
#endif
#if (SUITE == all || SUITE == direct_messaging)
