...
void ffa_mem_share_64_read_only_chk_vmsp_testentry(uint32_t test_num)
{
...
void ffa_mem_share_64_read_only_chk_spsp_testentry(uint32_t test_num)
{
...
void ffa_mem_share_64_read_only_chk_vmvm_testentry(uint32_t test_num)
{
