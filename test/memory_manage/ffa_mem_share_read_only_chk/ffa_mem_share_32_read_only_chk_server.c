...
static uint32_t ffa_mem_share_32_read_only_chk_server(ffa_args_t args)
{
    ffa_args_t payload;
...
uint32_t ffa_mem_share_32_read_only_chk_vmsp_server(ffa_args_t args)
{
    return ffa_mem_share_32_read_only_chk_server(args);
}

uint32_t ffa_mem_share_32_read_only_chk_spsp_server(ffa_args_t args)
{
    return ffa_mem_share_32_read_only_chk_server(args);
}

uint32_t ffa_mem_share_32_read_only_chk_vmvm_server(ffa_args_t args)
{
    return ffa_mem_share_32_read_only_chk_server(args);
}
