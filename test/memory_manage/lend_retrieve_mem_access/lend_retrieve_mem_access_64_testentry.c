...
void lend_retrieve_mem_access_64_vmvm_testentry(uint32_t test_num)
{
...
void lend_retrieve_mem_access_64_vmsp_testentry(uint32_t test_num)
{
...
void lend_retrieve_mem_access_64_spsp_testentry(uint32_t test_num)
{
